...
int main (int argc, char **argv)
{
  ...
  if ((bg = SDL_LoadBMP ("gfx/cam.bmp")) == NULL ) {
    fprintf (stderr, "Couln't find file: gfx/cam.bmp\n");
    exit (1);
  }
  if ((ballbmp = SDL_LoadBMP ("gfx/ball.bmp")) == NULL ) {
    fprintf (stderr, "Couln't find file: gfx/ball.bmp\n");
    exit(1);
  }
  //init object ball
