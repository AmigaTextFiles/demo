...
_unite__4RectFRC4Rect:
	move.w	rectTopLeftX(a1),d0			; topLeft = Point2D(MIN(topLeft.x, rectangle.topLeft.x), MIN(topLeft.y, rectangle.topLeft.y));
...
u.topLeftYOk:
	...
	move.w	rectBottomRightX(a1),d0			; bottomRight = Point2D(MAX(bottomRight.x, rectangle.bottomRight.x), MAX(bottomRight.y, rectangle.bottomRight.y));
	cmp.w	rectBottomRightX(a0),d0
	ble.s	u.bottomRightXOk
	move.w	d0,rectBottomRightX(a0)
u.bottomRightXOk:
	move.w	rectBottomRightY(a1),d0
	cmp.w	rectBottomRightY(a0),d0
	ble.s	u.bottomRightYOk
