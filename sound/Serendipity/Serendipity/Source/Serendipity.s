* Serendipity
* Coded by Tristan Greaves.
* © 1994, 1998 Tristan Greaves.  All Rights Reserved.
*
...
* Tested on an A1200 (2 Megs/2 Drives) - Kickstart 3  (now 22 Megs)
...
*
* Last changes:		progdir: used instead of assigns.
*                       Files moved around for source distribution.
*
*
* This source is freely distributable as long as no changes are made.
* Please do not use any of it in your own projects without asking us
* first.
*
* -------------------------------------------------------------------------
