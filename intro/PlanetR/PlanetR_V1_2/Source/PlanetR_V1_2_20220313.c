/*
  ...
  Version history:
  - V1.2 20220313, first public release
...
const BYTE ID[] = "$VER: PlanetR V1.2 - 20220313 by   Massimiliano Scarano   mscarano@libero.it\n";
