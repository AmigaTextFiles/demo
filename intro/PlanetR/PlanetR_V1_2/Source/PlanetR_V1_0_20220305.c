/*
  ...
  Version history:
  - V1.0 20220305, first public release
...
const BYTE ID[] = "$VER: PlanetR V1.0 - 20220305 by   Massimiliano Scarano   mscarano@libero.it\n";
