...
const BYTE ID[] = "$VER: LiquidMig V1.1 - 20170531 by   Massimiliano Scarano   mscarano@libero.it\n";



const UBYTE MsgText[] =
"ALIENTECH PROUDLY PRESENTS A DEMO CALLED LIQUIDMIG, LEFT MOUSE BUTTON TO EXIT.\
 DEMO V1.1 RELEASED 31-MAY-2017.\
 ...
 GREETINGS: MY WIFE AND DAUGHTER, INVENT, VINSOFT, ASZU, TONI WILEN, FLYPE44,\
...
void InitAudio( UBYTE Channel, UBYTE* Sample_p, LONG SampleSize, UWORD SampleRate, UWORD SampleVolume );
...
*/
  InitAudio( 0, Sample0_p, Sample0Size, 8000, 64 );
  InitAudio( 1, Sample1_p, Sample1Size, 11030, 64 );

  Hardware_p->dmacon = 0x83c3; /* DMASET 1000001111100000 +
                                         1000001111000011 */
...
*/
/*
  - Inits the audio hardware in order to play a sample looping it.
*/
function void InitAudio( UBYTE Channel, UBYTE* Sample_p, LONG SampleSize, UWORD SampleRate, UWORD SampleVolume )
{
