...
hanno all'inizio una INCDIR "MV_Code:".  Per assemblare e` quindi
necessario eseguire un "ASSIGN MV_Code:" alla directory che contiene i sorgenti
oppure dovete modificare gli INCDIR nei sorgenti.  Tutti i sorgenti fanno uso
del medesimo codice di startup, contenuto nel file MVStartup.S.  Si tratta di
un codice di startup MOLTO semplice da usare solo per le prove.
Non usatelo per le vostre demo!
