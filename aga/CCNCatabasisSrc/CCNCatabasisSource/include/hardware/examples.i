...
*
DSKBYTR         equ     dskbytr         ; Juat capitalization ....
DSKPT           equ     dskpt           ; "          "
DSKPTH          equ     dskpt
DSKPTL          equ     dskpt+$02
DSKLEN          equ     dsklen          ; "          "
...
SPR1DATB       equ      SPR1POS+$06 ; should use sd datab ...
...
SPR3DATB       equ      SPR3POS+$06 ; should use sd datab ...

SPR4POS        equ      spr+$20
SPR4CTL        equ      SPR4POS+sd_ctl
SPR4DATA       equ      SPR4POS+sd_dataa
SPR4DATB       equ      SPR4POS+$06 ; should use sd datab ...

SPR5POS        equ      spr+$28
SPR5CTL        equ      SPR5POS+sd_ctl
SPR5DATA       equ      SPR5POS+sd_dataa
SPR5DATB       equ      SPR5POS+$06     ; should use ad_datab
...
SPR7DATB       equ      SPR7POS+$06     ; should use ad_datab
*
* Color registers...
*
