...
<KPART>
    ...
    <fx>
        ...
        <Fx><Pa>BindPalette</Pa>  1st is always the name of the effect.
            ...
            <Pa> presh </Pa>     palette where to fade ( "B" )
            <Pa> pres </Pa>            optional source Palette(2)

            <Pa>CTE|0</Pa>              type of fade:0,1,2,3
            <Pa>CTE|0</Pa>            optional color 0->255 (0)
            <Pa> presh </Pa>       Palette where to fade ( "B" )
            <Pa> presh </Pa>       optional source Palette(2)
...
<KPART>
    <ID> part1  </ID>
        <Fx><Pa>BindPalette</Pa>  1st is always the name of the effect.
            ...
            <Pa>CTE|0</Pa>              type of fade:0,1,2,3
            <Pa>CTE|0</Pa>            optional color 0->255 (0)
            <Pa> lbig </Pa>     palette where to fade ( "B" )
            <Pa> lbig </Pa>            optional source Palette(2)
