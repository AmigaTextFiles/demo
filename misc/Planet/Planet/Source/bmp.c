...
UBYTE *LoadBMP(char *filename, BITMAPINFOHEADER *bitmapInfoHeader)
{
    FILE *filePtr;                          // the file pointer
    BITMAPFILEHEADER    bitmapFileHeader;   // bitmap file header
    UBYTE               *bitmapImage;       // bitmap image data
    ...
    bitmapImage = (UBYTE*)malloc(bitmapInfoHeader->biSizeImage);
